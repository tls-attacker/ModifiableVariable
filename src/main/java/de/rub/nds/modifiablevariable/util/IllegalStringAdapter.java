 ...
 *
 * <p>The adapter uses Apache Commons Text's {@link StringEscapeUtils} to perform the escaping and
 * unescaping. This handles escaping of common special characters like:
 *
 * <ul>
 *   <li>Control characters (e.g., \n, \r, \t)
 *   <li>Non-printable characters
 *   <li>Unicode characters
 *   <li>Characters that have special meaning in XML (e.g., &lt;, &gt;, &amp;)
 * </ul>
 *
 * <p>Usage example:
 *
 ...
 * }</pre>
 *
 * <p>With this adapter, the string will be properly escaped in XML, allowing for safe serialization
...
public class IllegalStringAdapter extends XmlAdapter<String, String> {
    ...
    /**
     * Creates a new adapter for handling strings with illegal or escape characters.
     *
     * <p>This default constructor initializes the adapter with no special configuration, as all
     ...
     *
     * <p>This method unescapes Java escape sequences to restore the original string with its
     * special characters.
     *
     ...
     *
     * <p>This method escapes special characters using Java escape sequences to ensure they can be
