 ...
 * 
 * <p>This modification takes the original long value and subtracts a
 ...
 *   <li>Testing long underflow conditions</li>
 *   <li>Checking boundary validation at long limits (Long.MIN_VALUE, Long.MAX_VALUE)</li>
 * </ul>
 * 
 * <p>Example usage:
 * <pre>{@code
 ...
 * long underflow can occur if the result is less than Long.MIN_VALUE,
...
public class LongSubtractModification extends VariableModification<Long> {
     ...
     * {@link #setSubtrahend(Long)} before applying the modification.
     */
     ...
     * 
     * <p>This method performs the subtraction operation on the input long
     * using the {@code -} operator. If the input is null, it returns
     * null to preserve null-safety.
     * 
     * <p>Note that this operation may result in underflow if the result
     * is less than {@link Long#MIN_VALUE}, which can be useful for
     * testing boundary conditions and underflow handling.
     *
     ...
     * 
     * <p>Two LongSubtractModification objects are considered equal if
