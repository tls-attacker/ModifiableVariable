 ...
 * 
 * <p>This modification applies a left shift operation to the original long
 ...
 * 
 * <p>In Java, left shifts on longs are performed modulo 64 (the width of a long).
 ...
 *   <li>Long overflow behavior (left shifts can cause overflow)</li>
...
public class LongShiftLeftModification extends VariableModification<Long> {
     ...
     * 
     * <p>This method performs the left shift operation on the input long
     ...
     * longs, shifts beyond 63 bits will overflow and produce unexpected results.
     *
     ...
     * 
     * <p>Two LongShiftLeftModification objects are considered equal if
