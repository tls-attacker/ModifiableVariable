 ...
 * the original integer value and a specified XOR mask using the {@code ^} operator.
...
public class IntegerXorModification extends VariableModification<Integer> {
     ...
     * {@link #setXor(Integer)} before applying the modification.
     */
     ...
     * 
     * <p>This method performs the bitwise XOR operation on the input integer
     ...
     * 
     * <p>Two IntegerXorModification objects are considered equal if
