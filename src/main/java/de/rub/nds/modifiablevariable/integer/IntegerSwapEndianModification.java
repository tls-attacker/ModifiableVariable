 ...
 * 
 * <p>This modification changes the endianness of the original integer value by
 * reversing the order of its bytes. It converts between little-endian and big-endian
 * representations, which is useful for testing protocol implementations that might
 * misinterpret byte ordering.
 * 
 * <p>For example, the decimal value 16909060 is represented as:
 * <ul>
 *   <li>0x01020304 in big-endian format</li>
 *   <li>0x04030201 in little-endian format</li>
 * </ul>
 * 
 * <p>This modification converts between these two representations, allowing testing of
 * code that might be sensitive to endianness issues.
 * 
 * <p>Example usage:
 * <pre>{@code
 ...
 * 
 * <p>Note that this modification is stateless as it has no configuration parameters.
 * All instances of this class behave identically and are considered equal.
 */
@XmlRootElement
public class IntegerSwapEndianModification extends VariableModification<Integer> {
     ...
     * 
     * <p>This method uses {@link Integer#reverseBytes(int)} to change the endianness
     * of the input value. If the input is null, it returns null to preserve null-safety.
     *
     ...
     * 
     * <p>Since this modification is stateless, all instances of this class are
     * considered equal to each other.
     *
     * @param obj The object to compare with
     * @return {@code true} if the object is also an IntegerSwapEndianModification, {@code false} otherwise
     */
    @Override
